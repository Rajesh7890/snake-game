...
class Game {
    ...
    setupEventListeners() {
        ...
        document.getElementById('btnUp').addEventListener('click', () => this.snake.setDirection('up'));
        document.getElementById('btnDown').addEventListener('click', () => this.snake.setDirection('down'));
        document.getElementById('btnLeft').addEventListener('click', () => this.snake.setDirection('left'));
        document.getElementById('btnRight').addEventListener('click', () => this.snake.setDirection('right'));
    }
    ...
    update() {
        ...
        if (head.x === this.food.x && head.y === this.food.y) {
            ...
            this.food = this.generateItem();
            this.adjustSpeed(2); // slightly faster
            ateFood = true;
        }
        ...
        if (this.bonus && head.x === this.bonus.x && head.y === this.bonus.y) {
            ...
            this.bonus = null;
            this.scheduleBonus();
            this.adjustSpeed(15); // much faster
            ateFood = true;
        }
        ...
        if (this.bomb && head.x === this.bomb.x && head.y === this.bomb.y) {
            ...
            this.adjustSpeed(-40); // significantly slower
